...
val dt : (lbl, lbl Hash_set.t) Base.Hashtbl.t -> (lbl, lbl Hash_set.t) Base.Hashtbl.t
val df : (lbl, lbl Hash_set.t) Hashtbl.t -> (lbl, lbl list) Hashtbl.t -> (lbl, lbl Hash_set.t) Hashtbl.t
